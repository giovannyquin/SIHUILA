...
<div class="marketing">
    ...
    <div class="row">
        {{ link_to("UnidadCrear/", "Crear Unidad Minera", array("class" => "btn btn-primary")) }}
    </div>
       ...
       <table class="table table-striped table-hover table-bordered table-responsive">
          ...
          @foreach($unidad as $unidad)
             <tr>
                ...
                <td style="text-align: center;"> {{ link_to('FrenteMinero/'.$unidad->id_minamina, 'Ir a Frentes', array("class" => "btn btn-info btn-md")) }} </td>
                <td style="text-align: center;"> {{ link_to('UnidadMinera/'.$unidad->id_minamina.'/edit', 'Editar', array("class" => "btn btn-success btn-md")) }} </td>
                <td style="text-align: center;"> {{ link_to('UnidadMinera/'.$unidad->id_minamina.'/', 'Eliminar', array("class" => "btn btn-danger", "data-method" => "delete", "rel" => "noflow")) }} </td>
             </tr>
             <?php $a++; ?>
          @endforeach     
          </tbody>
